import { Component, ViewEncapsulation, OnDestroy, ElementRef, ViewChild, AfterViewInit } from '@angular/core';
import { MatCardModule } from '@angular/material/card';
import { of } from 'rxjs';
import { CarouselComponent, CarouselOptions } from '../../carousel/carousel.component';
...
@Component({
  ...
  standalone: true,
  imports: [CarouselComponent, CommonModule, MatCardModule],
  templateUrl: './case-study-page.component.html',
  styleUrl: './case-study-page.component.scss',
  encapsulation: ViewEncapsulation.None
})
export class CaseStudyPageComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    if (this.canvasRef?.nativeElement) {
      this.webglService.initialize(this.canvasRef.nativeElement);
    }
  }
